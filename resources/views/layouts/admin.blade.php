...
<head>
    ...
    <title>@yield('title', 'Dashboard') — {{ config('defxc.company_short') }} Admin</title>
...
<aside class="sidebar">
    <div class="sidebar-brand">
        ...
        <div class="app-label">Admin Portal</div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.wallets.index') }}"
           class="nav-item {{ request()->routeIs('admin.wallets.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.card-requests.index') }}"
           class="nav-item {{ request()->routeIs('admin.card-requests.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" /></svg>
            Card Requests
        </a>

        <div class="nav-section-label">Tools</div>
        <a href="{{ route('admin.mailer.index') }}"
           class="nav-item {{ request()->routeIs('admin.mailer.*') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">{{ auth()->user()->username }}</div>
